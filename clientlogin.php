...
<div class="container"  style="max-width:1800px;margin-top:80px;">
  ...
  <div class="w3-row" >
    ...
    <!-- Profile -->
      <div class="profile">
          ...
          <form class="w3-container w3-card-4 w3-light-grey" method="GET" action="afterclient.php">
  <h2>About Case</h2>
	
  <p>
  <label>Client Name</label>
  <input class="w3-input w3-border w3-round-large" name="cli" type="text"></p>
  <p>
  <label>Type</label>
  ...
  <textarea name="desc" rows=7 cols=70>
  Please Describe
  </textarea></p>
  <p>
  <input type=submit></p>
