...
<html>
	...
	<body>
		...
		<form action="logcli.php" method="GET">
			<h1>LOGIN</h1>
			<br>
		...
		<form action="a2.php" method="GET">
			...
			<br>
			<input type="text" placeholder="CLIENT" style="height:20px; width:550px; background-color:#f2f2f2;  border:1px solid #d9d9d9;" required>
			<br><br><br>
			<input  class="submit" type="submit" style="height:48px; width:85px; font-size:1.2em;">
